        ...
        if (currentMode == ACTIVE) {
            ...
            //RIGHT-----------------------------------------------------------------------------------
                    ...
                    if (rf_max_val > AMP_THRESHOLD) {
                        grippers.amp_max[RH_RF] = (double)((double)rf_max_val / (double)12000) * 255;
            ...
            //LEFT-----------------------------------------------------------------------------------
                    ...
                    if (lf_max_val > AMP_THRESHOLD) {
                        grippers.amp_max[RH_LF] = (double)((double)lf_max_val / (double)12000) * 255;
    ...
    if (lh_calibrated) {
        ...
        if (currentMode == ACTIVE) {
            ...
            //RIGHT-----------------------------------------------------------------------------------
                    ...
                    //Make sure that the max val is above the noise threshold
                    if (rf_max_val > AMP_THRESHOLD) {
                        grippers.amp_max[LH_RF] = (double)((double)rf_max_val / (double)12000) * 255;
            ...
            //LEFT-----------------------------------------------------------------------------------
                    ...
                    //Make sure that the max val is above the noise threshold
                    if (lf_max_val > AMP_THRESHOLD) {
                        grippers.amp_max[LH_LF] = (double)((double)lf_max_val / (double)12000) * 255;
