"""autogenerated by genpy from task_control/DTWUpdate.msg. Do not edit."""
import sys
...
class DTWUpdate(genpy.Message):
  _md5sum = "420cd38b6b071cd49f2970c3e2cee511"
  _type = "task_control/DTWUpdate"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DTWUpdate, self).__init__(*args, **kwds)
