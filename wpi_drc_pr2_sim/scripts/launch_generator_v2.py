...
if __name__ == '__main__':
    ...
    launch.write('<launch><param name="/use_sim_time" value="true" /><arg name="gui" default="true"/><node name="gazebo" pkg="gazebo" type="gazebo" args="$(find gazebo_worlds)/worlds/empty.world" respawn="false" output="screen"/><!-- start gui --><group if="$(arg gui)"><node name="gazebo_gui" pkg="gazebo" type="gui" respawn="false" output="screen"/></group><!--send valve urdf to param server-->')
