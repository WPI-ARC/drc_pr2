...
class TrajectoryPlanner:
    ...
    def generate_points(self):
        ...
        self.T0_LH1_EXIT = dot(temp,MakeTransform(matrix(rodrigues([-pi/4,0,0])),transpose(matrix([0.1,0.1,-0.2]))))
        ...
        self.T0_RH1_EXIT = dot(temp,MakeTransform(matrix(rodrigues([-pi/4,0,0])),transpose(matrix([-0.1,-0.1,-0.2]))))
        ...
        arg1 = str(GetRot(self.T0_LH1_EXIT)).strip("[]")+str(GetTrans(self.T0_LH1_EXIT)).strip("[]")
        arg1 = arg1.replace("\n"," ")

        arg2 = str(GetRot(self.T0_RH1_EXIT)).strip("[]")+str(GetTrans(self.T0_RH1_EXIT)).strip("[]")
        arg2 = arg2.replace("\n"," ")        

        self.exit = self.probs[0].SendCommand('DoGeneralIK exec nummanips 2 maniptm 7 '+arg1+' maniptm 5 '+arg2)

        print "Got self.exit:"
        #Validate point
        if(not self.is_valid(self.exit,"exit")):
            print "Hey: No IK Solution found! Move the robot!"
        ...
        #Validate point
        # if(not self.is_valid(self.approachik_1,"approachik_1")):
        #     print "Hey: No IK Solution found! Move the robot!"
        #     self.notPlanning = True
        #     return []
        ...
        # if(not self.is_valid(self.approachik_2,"approachik_2")):
        #     print "Hey: No IK Solution found! Move the robot!"
        #     self.notPlanning = True
        #     return []
            ...
            if(self.which_planner == "cbirrt"):    
                ...
                try:
                    ...
                    try:
                        ...
                        if(self.mode == "openrave_with_ros"):
                            #self.notPlanning = True
                            #answer = pr2_rave2ros_traj_play_from_file(fname)
                            #self.notPlanning = False
                            pass
    ...
    def arm_planner(self):
        ...
        #TSRChainString_A1 = SerializeTSRChain(0,1,0,1,TSRString_A1_R,'NULL',[])+' '+SerializeTSRChain(0,1,0,1,TSRString_A1_L,'NULL',[])

        self.robot.SetActiveDOFValues(self.initconfig)
        time.sleep(0.5)
        #self.plan_and_save_trajectory(goaljoints,'movetraj0.txt',False,False)
        ...
        #self.plan_and_save_trajectory(goaljoints,'movetraj1.txt',False,False)
        ...
        #     answer = self.probs[0].SendCommand('RunCBiRRT jointgoals %d %s'%(len(goaljoints),Serialize1DMatrix(matrix(goaljoints))))
        ...
        #     try:
        #         if(self.mode == "openrave_only"):
        #             answer = self.probs[0].SendCommand('traj movetraj1.txt');
        #             self.robot.WaitForController(0)
        #         if(self.mode == "openrave_with_ros"):
        ...
        self.plan_and_save_trajectory(goaljoints,'movetraj2.txt',False,False)
        ...
        #     try:
        #         if(self.mode == "openrave_only"):
        #             answer = self.probs[0].SendCommand('traj movetraj2.txt');
        #             self.robot.WaitForController(0)
        #         if(self.mode == "openrave_with_ros"):
        ...
        self.plan_and_save_trajectory(goaljoints,'movetraj3.txt',True,False,TSRChainString_StoG)
        ...
        #     try:
        #         if(self.mode == "openrave_only"):
        #             answer = self.probs[0].SendCommand('traj movetraj3.txt');
        #             self.robot.WaitForController(0)
        #         if(self.mode == "openrave_with_ros"):
        ...
        self.plan_and_save_trajectory(goaljoints,'movetraj5.txt',False,False)
        ...
        #     try:
        #         if(self.mode == "openrave_only"):
        #             answer = self.probs[0].SendCommand('traj movetraj5.txt');
        #             self.robot.WaitForController(0)
        #         if(self.mode == "openrave_with_ros"):
        ...
        # self.plan_and_save_trajectory(goaljoints,'movetraj6.txt',False,False)
        ...
        #     try:
        #         if(self.mode == "openrave_only"):
        #             answer = self.probs[0].SendCommand('traj movetraj6.txt');
        #             self.robot.WaitForController(0)
        #         if(self.mode == "openrave_with_ros"):
...
#       self.plan_and_save_trajectory(goaljoints,'movetraj7.txt',False,False)
        ...
        #     try:
        #         if(self.mode == "openrave_only"):
        #             answer = self.probs[0].SendCommand('traj movetraj7.txt');
        #             self.robot.WaitForController(0)
        #         if(self.mode == "openrave_with_ros"):
