...
class TrajectoryPlanner:
    ...
    def handle_play_trajectories(self,req):
        ...
        pr2_rave2ros_traj_play_from_file('movetraj0.txt',1) # initconfig --> approach 1
        pr2_rave2ros_traj_play_from_file('movetraj1.txt',1) # approach 1 --> approach 2
        pr2_rave2ros_traj_play_from_file('movetraj2.txt',1) # approach 2 --> startik

        numreps = 4
        for r in range(numreps):
            pr2MoveGrippers('close') # Close grippers in ROS so that we can interact with the wheel in Gazebo
            pr2_rave2ros_traj_play_from_file('movetraj3.txt',5) # startik --> goalik
            pr2MoveGrippers('open') # Open grippers in ROS so that we can interact with the wheel in Gazebo
            pr2_rave2ros_traj_play_from_file('movetraj4.txt',5) # goalik --> startik

        pr2_rave2ros_traj_play_from_file('movetraj5.txt',1) # startik --> approach 2
        pr2_rave2ros_traj_play_from_file('movetraj6.txt',1) # approach 2 --> approach 1
        pr2_rave2ros_traj_play_from_file('movetraj7.txt',1) # approach 1 --> initconfig
